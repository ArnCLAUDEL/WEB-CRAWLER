...
public class ServiceReply extends Message {
	public static final Creator<ServiceReply> CREATOR = ServiceReply::new;
	...
	private ServiceReply() {
		super(Flag.SERVICE_REPLY);
	}
	
	public ServiceReply(String hostname, String link, Set<String> urls) {
		this();
